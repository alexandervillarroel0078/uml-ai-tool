...
//   listMethods,    createMethod,    updateMethod,    deleteMethod,
// } from "../api/classes";
...
// /**
//  * Inspector de la clase seleccionada:
//  *  - Renombrar clase (autosave)
//  *  - CRUD de atributos (name, type, required)
//  *  - CRUD de métodos (name, return_type)
//  *
//  * Props:
//  *  - selected: clase seleccionada (objeto) o null
//  *  - onSoftUpdate?(patchLocal)  // para reflejar cambios locales en la lista/canvas sin recargar todo
//  */
...
//   };
//   const smallInput = { ...input, height: 30 };
...
//         {attr.map(a => (
//           <div key={a.id} style={{ border: "1px solid #334", borderRadius: 8, padding: 10 }}>
...
//                 placeholder="tipo (string, int, date, money, etc.)"
//                 style={smallInput}
//               />
...
//       <div style={{ display: "grid", gap: 8, marginTop: 8 }}>
//         {meth.map(m => (
//           <div key={m.id} style={{ border: "1px solid #334", borderRadius: 8, padding: 10 }}>
//             <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: 8 }}>
//               <input
//                 value={m.name ?? ""}
...
//                 placeholder="retorno (void, string, int, ...)"
//                 style={smallInput}
//               />
//             </div>
//             <div style={{ marginTop: 8 }}>
